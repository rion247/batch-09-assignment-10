...
const SingleLoadingCraftCategoryItem = ({ item }) => {
        ...
        <div>
            ...
            <article className="flex flex-col w-full shadow-lg">
                ...
                <div className="flex flex-col p-6">
                    ...
                    <Link className='py-2 w-full bg-sky-900 hover:bg-sky-800 text-white text-center mt-8' to={`/craftCategoryItemsDetailsPage/${_id}`}>View Details</Link>
...
export default SingleLoadingCraftCategoryItem;