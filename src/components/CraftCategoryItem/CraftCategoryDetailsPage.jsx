...
const CraftCategoryDetailsPage = () => {

    const craftCategoryItems = useLoaderData();

    console.log(craftCategoryItems);

    const { _id, itemName, itemImageURL, itemSubcategory, itemProcessingTime, itemShortDescription, itemPrice, itemRating } = craftCategoryItems;
    ...
    return (
        <div className="max-w-[350px] p-4 mx-auto md:max-w-xl lg:max-w-4xl xl:max-w-7xl  mt-4 md:mt-6 lg:mt-8 xl:mt-32 font-poppins text-black mb-16 md:mb-20 lg:mb-32 xl:mb-40">
            ...
            <a rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-50">
                <img src={itemImageURL} alt="...Loading" className="object-cover w-full h-48 md:h-60 lg:h-[450px] xl:h-[400px] rounded lg:col-span-7 dark:bg-gray-500" />
...
export default CraftCategoryDetailsPage;